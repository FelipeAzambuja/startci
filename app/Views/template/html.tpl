...
<head>
	<meta charset="UTF-8">
	<title>Welcome to StartCI 4!</title>
	...
	<style {literal}{csp-style-nonce} {/literal}>
		* {
...
<header>
	...
	<div class="menu">
		<ul>
			<li class="logo"><a href="https://codeigniter.com" target="_blank">{Logo}</a></li>
	...
	<div class="heroe">
		...
		<h1>Welcome to StartCI {php} echo CodeIgniter\CodeIgniter::CI_VERSION {/php}</h1>
